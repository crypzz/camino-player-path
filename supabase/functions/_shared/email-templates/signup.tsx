...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email to activate your Camino passport</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>
          Welcome to your <em style={serif}>passport.</em>
        </Heading>
        <Text style={text}>
          Thanks for joining{' '}
          ...
          . Confirm your email ({recipient}) to start tracking verified
          performance.
        </Text>
